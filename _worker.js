/**
 * Cloudflare Pages Worker - IPTV HLS Stream & API Proxy
 *
 * Named `_worker.js` at the root of the project to intercept requests on a
 * Cloudflare Pages deployment and act as the HLS proxy.
 */
