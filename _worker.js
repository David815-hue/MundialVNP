/**
 * Cloudflare Pages Advanced Worker – IPTV HLS Stream & API Proxy
 * 
 * Named `_worker.js` at the root of the project to automatically intercept
 * all requests on the Cloudflare Pages domain and act as the HLS proxy.
 */
